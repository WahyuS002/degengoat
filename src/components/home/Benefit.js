            ...
            <div className="md:grid md:grid-cols-9 gap-6 items-center">
                ...
                <div className="md:col-span-5 md:col-start-5 mt-4 md:mt-0">
                    ...
                    <p className="mt-4 text-base md:text-lg text-gray-300 text-justify leading-relaxed">
                        By owning Degen Goat, you will get full access to make Degen Goat derivative art. There will be Degen Goat Collab edition, where all collab between us become one. 90% of total
                        sales will be transfered to the creator, 10% will go to the Degen Goat Bank. Degen Goat Bank will be use wisely according to the wishes of all collectors.
                        <br />
                        <br />
