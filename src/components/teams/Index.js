                    ...
                    {teams.map((team) => (
                        <div className="relative">
                            {team.label === 'Core Team' ? (
                                <div>
                                    <div className="absolute right-6 top-6 rounded-full w-8 h-8 bg-violet-700 flex items-center justify-center cursor-pointer group">
                                        <span className="group-hover:visible group-hover:z-50 invisible absolute rounded-lg p-1 bg-violet-700 text-white -mt-24 w-36 text-center">Core Team</span>
                                ...
                                <div className="absolute right-6 top-6 rounded-full w-8 h-8 bg-primary flex items-center justify-center cursor-pointer group">
                                    <span className="group-hover:visible group-hover:z-50 invisible absolute rounded-lg p-1 bg-primary text-white -mt-24 w-36 text-center">Additional Team</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path
                                            fill-rule="evenodd"
                            ...
                            <div className={(team.label === 'Core Team' ? 'border-violet-700 ' : 'border-primary ') + 'overflow-hidden w-full rounded-full border-4 border-dashed p-2'}>
