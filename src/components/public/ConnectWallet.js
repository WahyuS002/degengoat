...
export default function ConnectWallet() {
    ...
    return (
        <div>
            {!blockchain.registeredStatus && <RegisterModal openModal={openModal} handleClose={() => setOpenModal(false)} />}
                ...
                <>
                    {blockchain.registeredStatus ? (
                        ...
                        <div>
                            ...
                            >
                                <span className="w-2 h-2 rounded-full bg-violet-500 mr-2 shadow-[0px_0px_12px] shadow-violet-400"></span>
                                <span>Register Your Wallet</span>
                            </button>
                        </div>
                    )}
                </>
